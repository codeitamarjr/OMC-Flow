            ...
            <flux:dropdown position="bottom" align="start">
                ...
                <flux:menu class="w-[220px]">
                    ...
                    <flux:menu.radio.group>
                        ...
                        @if ($hasUpdate)
                            <flux:menu.item :href="route('settings.update')" icon="arrow-path" class="!text-blue-600 hover:!bg-blue-100">
                                Update Available
                            </flux:menu.item>
                        @endif
                    </flux:menu.radio.group>
                    ...
                    <flux:menu.radio.group>
                        ...
                        @if(auth()->user()->currentBusiness)
                            ...
                            <flux:menu.item :href="route('company.service.provider.manager')" icon="document-text" wire:navigate>{{ __('Service Providers') }}</flux:menu.item>
